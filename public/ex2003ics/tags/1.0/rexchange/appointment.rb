...
module RExchange
  class Appointment < GenericItem
    ...
    attribute_mappings :all_day_event => 'urn:schemas:calendar:alldayevent',
	  ...
	  :cc => 'urn:schemas:httpmail:cc', # Added Support for Attendees
	  ...
	  :from => 'urn:schemas:httpmail:from', # Added Support for Organizer
      ...
      :timezone => 'urn:schemas:calendar:timezone',
  	  :to => 'urn:schemas:httpmail:to', # Added Support for Attendees
